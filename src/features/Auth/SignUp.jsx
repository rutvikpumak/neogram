...
export function SignUp() {
  ...
  return (
    <div className="auth-container w-full h-screen text-gray-800  px-4 py-6 flex flex-col justify-center sm:py-12">
      <div className="w-2/5 py-3 sm:max-w-xl mx-auto text-center sm:w-11/12">
        <div className="mt-4 bg-white shadow-md sm:rounded-lg text-left">
          ...
          <div className="px-12 py-4 pb-8 sm:px-6 ">
            ...
            <div className="pt-8">
              <div className="flex gap-4 sm:flex-col mb-4 sm:gap-2 sm:mb-2">
                <div>
              ...
              <input
                ...
                required
              />
              <label className="block mt-3 font-semibold sm:mt-2">Password</label>
              <input
                type="password"
